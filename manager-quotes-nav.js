...
function ensureInteractive(){
 if(window.DBM?.__interactiveQuotesV84Ready||document.querySelector('script[data-dbm-iq-v84]'))return;
 const s=document.createElement('script');s.src='manager-interactive-quotes-v84.js?v=85';s.dataset.dbmIqV84='1';s.async=false;s.onerror=()=>{s.remove();setTimeout(ensureInteractive,1200)};document.body.appendChild(s);
}
